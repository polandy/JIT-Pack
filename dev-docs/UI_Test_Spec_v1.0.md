...
| E2E-VIS-08 | Visual G-2 detail sheet | all | The one surface reachable from every screen in every mode, and covered by no baseline at all until 2026-08-23 — which is how its state glyph came to sit half a line above its title without anything going red. E2E-G2-08 guards that single measurement; this guards the rest of the header, the state line and the sheet's own plane. |
