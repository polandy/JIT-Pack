...
| E2E-G3-02 | G-3 Lock staleness | server | A lock older than the instance's window (15 min by default, `JITPACK_LOCK_TIMEOUT`; clock-advanced) is no longer treated as locking on the other client. |
