...
<div class="vwrap">
  <div class="vhead">
    <h1>Eine Gruppe anschauen, bevor man sie nimmt</h1>
    <p>M3 Schritt 3 zeigt heute „Makro Fotografie · 5 Artikel“ — <em>welche</em> fünf, sagt der Screen nicht.
      Den Inhalt sieht man nur im M8-Editor, und der Weg dorthin kostet den Wizard-Entwurf.
      Dieselbe Lücke hat der M8-Gruppen-Picker und der M14-Retarget-Picker.</p>
    <p>Drei Formen, dieselben Daten. Jede ist anklickbar — die Kosten stehen unter der Variante.</p>
  </div>
...
const VARIANTS = [
  { key:'A', title:'Peek-Sheet', render:variantA,
    why:'Der Chevron öffnet ein Sheet über der Liste — dieselbe Grammatik wie M5 und das M8-Positions-Sheet. Die Liste bleibt, wo sie war; das Sheet trägt beliebig viele Artikel und passt unverändert in den M8-Picker und M14.',
    cost:'Kosten: eine Ebene mehr. Auf einer Auswahlliste tippt man mehrfach hinein und wieder heraus.' },
  { key:'B', title:'Zeile aufklappen', render:variantB,
    why:'Der Chevron faltet die Artikel unter der Zeile auf. Kein Overlay, kein Kontextwechsel, die Checkbox bleibt in Reichweite — man vergleicht zwei Gruppen, indem man beide offen lässt.',
    cost:'Kosten: die Liste springt. Bei „Camping Basis“ mit 6 Artikeln schiebt eine offene Gruppe die nächste aus dem Bild.' },
  { key:'C', title:'Zeile sagt es selbst', render:variantC,
    why:'Keine Interaktion: die Zeile trägt die ersten drei Artikel als zweite Zeile. Null Taps, kein Zustand, nichts zu schließen — dieselbe Idee wie „enthält: …“ auf der Vorlagen-Zeile in M7.',
    cost:'Kosten: es bleibt eine Andeutung. „+2“ beantwortet „ist das Stativ dabei?“ nicht.' },
]
