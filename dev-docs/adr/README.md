...
| [022](ADR-022_Conflict_Revert_As_New_Mutation.md) | A manual conflict revert is an ordinary mutation with a fresh server HLC — over rewriting the row in place, a client-side re-issue, and leaving the log read-only (NFR-4.2a) | Accepted |
