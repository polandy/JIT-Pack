...
**Status:** Accepted (2026-08-19) — revisit trigger fired 2026-09-20, superseded in intent by
[ADR-067](ADR-067_The_Store_Gets_A_Migration_Path_Inside_0x.md). Still describes what the code does until that
mechanism lands.
