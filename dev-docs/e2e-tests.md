...
| M4/M5 names from the inventory | E2E-M4-103 (FR-27.16: the ⋮ sheet, „All", undo, and the entry gone once the names agree), E2E-M5-30 (the one-row line in M5) | `local` | [`inventory-names.spec.ts`](../client/e2e/inventory-names.spec.ts) |
