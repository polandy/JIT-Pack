...
| FR-25.21 membership · FR-25.8 per-person quick-add | E2E-M5-18, E2E-M5-19, E2E-M5-20, E2E-M5-24 (FR-21.16: the head is set louder than its children, read off computed type), E2E-M5-21 (the state follows the numbers — implemented since 2026-08-30 and missing from this row until the M5 audit), E2E-M5-26 (FR-25.21c: the *Alle Reisenden* head row adds the missing travelers and keeps a chosen amount), E2E-M4-12/E2E-M4-58 (one cluster, not N items), E2E-M4-14 (packing one instance does not flatten the other), E2E-M4-64 (G-8: the mode is absent), E2E-M4-65 (the browse-sheet path), E2E-M4-78/79 (FR-25.13g: „für alle" on a free line and on a carried one), E2E-M4-80/81 (FR-25.13h: assigning one traveler — the avatar button up to three, the long-press menu above) | `local` | [`membership.spec.ts`](../client/e2e/membership.spec.ts) |
