...
| M1 dashboard (populated) | E2E-M1-01 (card, open count, three previews, the remainder, and the card into M4), E2E-M1-02 (the prep card, listing only since 2026-09-18 — resolved in M5, which clears it), E2E-M1-06/06b (the departure-day section), E2E-M1-07 (the prep name opens its row; its head, count and card role since FR-21.28), E2E-M1-03b (no delegation section without accounts), E2E-M1-08 (the planned-trips section, and that starting a trip moves it; its head, count and card role since FR-21.28), E2E-M1-10 (FR-7.4 trip todos reported read-only, and the way into the trip), E2E-M1-11 (the task check and the packing share move independently) | `local` | [`dashboard.spec.ts`](../client/e2e/dashboard.spec.ts) |
...
| G-10 trip presence | E2E-G10-01 (facepile, the in-sync badge, the tap), E2E-G10-02 (the lagging half over the wire), **E2E-G10-03** (the cloud sheet names who has a shared trip open and stops when they leave, FR-4.9, since 2026-09-19) | `server` | [`server/presence.spec.ts`](../client/e2e/server/presence.spec.ts) |
