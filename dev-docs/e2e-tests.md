...
| Visual baselines | E2E-VIS-01 … E2E-VIS-14 (VIS-13 M25 since 2026-09-21, VIS-14 M26 since 2026-09-25) | `local` | [`visual.spec.ts`](../client/e2e/visual.spec.ts) |
...
| Trip notes across identities (FR-7.9, since 2026-09-22; threads FR-7.13, since 2026-09-25) | ~~E2E-M25-11~~ (moved to E2E-M26-03), **E2E-M26-03** (a thread is new for a second member, counted on the notes pill, the tick clears both, and the sheet names who — decision 3/4), **E2E-M26-04** (a reply re-opens a ticked thread for the other traveller with only the reply unseen; replying is not ticking; ✎ for the author only), **E2E-M1-14** (M1's *Neue Notizen* card, amended: a thread by its newest unseen entry, ticked from the card, back with a reply, and its words open the thread on M26) | `server` | [`server/trip-notes.spec.ts`](../client/e2e/server/trip-notes.spec.ts) |
| M26 trip notes (FR-7.13, since 2026-09-25) | **E2E-M26-01** (a view of its own, M25 one list again, a thread named by title or first line, the sheet's `tel:` link, the delete), **E2E-M26-02** (a reply lifts its thread and lands on top inside it, one level, the author's in-place edit with *edited*, the delete naming its replies) | `local` | [`trip-notes.spec.ts`](../client/e2e/trip-notes.spec.ts) |
