...
Fifteen cases, Local Mode; eight landed with the §3.24 tag rebuild, four with the
2026-08-30 audits (two M9, two M10) and three with the FR-24.6/24.7 rebuild of the
screen's tools (2026-09-13). What they cover is deliberately what a unit test
