...
| Search lifts the reveal switches (FR-25.32), the Erledigte switch keeps its tick | E2E-M4-127, E2E-M4-128 | `local` | [`packing-list.spec.ts`](../client/e2e/packing-list.spec.ts) |
