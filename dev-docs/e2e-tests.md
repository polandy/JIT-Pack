...
Sixteen cases, Local Mode; eight landed with the §3.24 tag rebuild, four with the
2026-08-30 audits (two M9, two M10), three with the FR-24.6/24.7 rebuild of the
screen's tools and two more with FR-24.8, which removed the swipe axis
(2026-09-13). One went the other way in the same pass: **E2E-M9-08 is retired**,
