...
| Taken off the list (FR-5.8) | E2E-M4-91, E2E-M4-92, E2E-M4-95, E2E-M4-115 (ADR-065: the unused inventory item goes along), E2E-M4-114 (FR-25.21: one traveler's instance goes, the other's stays packed) | `local` | [`remove-item.spec.ts`](../client/e2e/remove-item.spec.ts) |
