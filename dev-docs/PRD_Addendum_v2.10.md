...
* **NFR-4.12 (Internationalization — accepted 2026-08-07; proposed 2026-07-17):** The UI is fully localizable; no
  ...
  * **Where the requirement stops: a product statement is localized, a technical diagnosis is not** (owner,
    ...
    about a broken input, which is written for whoever has to fix the file and stays English. The nine parse errors
    ...
    each catalogue with none missing on either side, and no literal `label=`, `placeholder=` or `title=` in a
    production template.
