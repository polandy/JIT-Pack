...
| `helpers/m4.ts`         | M4 packing list                | `tripWithRows`, `startTrip`, `packRow`, `row`, `openRowMenu`, `chooseInRowMenu`, `assignTraveler`, `openForWhom`, `lightTraveler`, `setMemberInM5`, `openTripTodos`, `addTripTodo`                                                                                                                                                                                                             |
