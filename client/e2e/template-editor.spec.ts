...
/**
 * A tagged master item through M10's own path (E2E-M8-18 needs primary
...
test.describe('M8 template editor — scope shape and quick-add (FR-27.6/25.13)', () => {
  ...
  test('E2E-M8-18: the empty composer offers chips, never the already chosen, and a chip lands a row (FR-25.13c)', async ({
    page,
  }) => {
