...
test.describe('M4 — the trip’s own todos (FR-7.4) @local @m4', () => {
  ...
  /**
   * E2E-M4-131 (FR-7.5, G-8): Local Mode has nobody to hand a todo to, so the
   ...
   * box the seat would share; the seat itself is E2E-M4-130's.
   */
  test('E2E-M4-131: a trip todo offers no seat where there is nobody to assign it to', async ({
    page,
  }) => {
    await tripWithRows(page, ['Zelt'], 'Samedan')
    await addTripTodo(page, 'Water the plants')
