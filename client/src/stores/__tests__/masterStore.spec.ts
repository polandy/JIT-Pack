...
describe('portableResolvers (FR-24.1/24.2, ADR-024)', () => {
  it('resolves an item and its tags, primary first', () => {
    const store = useMasterStore()
    store.applyChanges([
      { seq: 1, table: 'items', id: 'i1', deleted: false, row: { name: 'Wanderschuhe', icon: '🥾' } },
      ...
      { seq: 4, table: 'item_tags', id: 'a2', deleted: false, row: { item_id: 'i1', tag_id: 'g2', position: 1 } },
      { seq: 5, table: 'item_tags', id: 'a1', deleted: false, row: { item_id: 'i1', tag_id: 'g1', position: 0 } },
    ])
