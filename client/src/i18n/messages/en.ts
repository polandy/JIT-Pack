...
export const en = {
  ...
  'settings.prefNoteReply': 'Replies to notes',
  ...
  'tripTodos.figurePacking': 'While packing {done}/{total}',
  ...
  'tasks.bulkToDuring': 'On the road',
  ...
  // two-line rows, a sheet ordered by how often each act is wanted.
  'tasks.addPlaceholder': 'New task…',
  'tasks.duringShort': 'On the road',
  'tasks.phaseLabel': 'When',
  'tasks.tagAdd': '＋ Tag',
  'tagPick.search': 'Search or create tags…',
  'tagPick.create': 'Create “{name}”',
  'tagPick.unassign': 'Remove tag: {tag}',
  'tasks.tagFiledUnder': 'Filed under: {tag}',
  'tasks.tagNone': 'No tag yet — the task is listed under “{group}”.',
  'tasks.entrySheetNew': 'New task',
  'tasks.entryName': 'Task',
  'tasks.quickBeforeDeparture': 'Before departure',
  'tasks.quickPick': 'Date…',
  'tasks.dueClear': 'Due {day} — remove',
  'tasks.dueGroup': 'Due',
  'tasks.beforeHistory': 'Before the trip · {n} done',
  ...
  'tasks.markDone': 'Done',
  'tasks.reopen': 'Reopen',
  'tasks.renamedToast': '“{body}” changed',
  'tasks.bulkDone': 'Done',
  'tasks.bulkTagShort': 'Tag',
  'tasks.bulkRemove': 'Delete',
  'tasks.bulkAssign': 'Assign',
  'tasks.bulkAssignTitle': 'Who takes one task? | Who takes {n} tasks?',
  'tasks.bulkAssigned': 'One task → {who} | {n} tasks → {who}',
  'tasks.bulkUnassigned': 'One task: nobody responsible | {n} tasks: nobody responsible',
  'tasks.bulkResolved': 'One task done | {n} tasks done',
  'tasks.bulkDueSet': 'One task due {date} | {n} tasks due {date}',
  'tasks.bulkDueCleared': 'Due date taken off one task | Due date taken off {n} tasks',
  'tasks.bulkRemoved': 'One task deleted | {n} tasks deleted',
  'tasks.bulkDueTitle': 'Due date for one task | Due date for {n} tasks',
  ...
  'notes.addPlaceholder': 'A note for everyone — a code, a number…',
  'notes.titlePlaceholder': 'Title (optional)',
  'notes.shareHint': 'Everyone on the trip sees the note.',
  'notes.share': 'Share',
  'notes.send': 'Send',
  'notes.new': 'New',
  'notes.newCount': 'New {n}',
  'notes.newDivider': 'New since your last visit',
  'notes.markRead': 'Read',
  'notes.replyPlaceholder': 'Reply…',
  'notes.replyLabel': 'Write a reply',
  'notes.replies': '{n} reply | {n} replies',
  'notes.edited': 'edited',
  'notes.more': 'More on this entry',
  'notes.seenBy': 'Seen by {names}',
  'notes.copy': 'Copy text',
  'notes.copied': 'Copied',
  'notes.codeCopied': '{code} copied',
  'notes.removeWithReplies': 'Delete note, with {n} reply | Delete note, with {n} replies',
  'notes.removeReply': 'Delete reply',
  ...
  'notify.body.note_reply': '{actor} replied to “{thread}”: {preview}',
  'notify.body.note_replyPlain': '{actor} replied to a note',
