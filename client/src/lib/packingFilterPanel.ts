...
export interface SwitchState {
   ...
   * reveal bar labels itself with. Not the trip's packed *units*
   * (`kpis.packedItems`): that would put two numbers on one screen for one
   * sentence, neither of them the set the switch reveals (FR-25.22).
   */
  packedCount: number
